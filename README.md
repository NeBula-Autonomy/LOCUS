...
An existing pose graph zip-file generated by the `save_graph` service (as documented in the [loop_closure_tools](internal/loop_closure_tools) module) can be restored by providing the filename as command-line argument:
