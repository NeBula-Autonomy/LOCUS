...
#### Play BAGFILE 
tmux send-keys -t 1 "sleep 2; rosparam set /use_sim_time true && rosbag play -r 1.0 ~/bags/classic/tunnel.bag --clock --pause /velodyne_points:=/$ROBOT_NAME/velodyne_points" C-m
